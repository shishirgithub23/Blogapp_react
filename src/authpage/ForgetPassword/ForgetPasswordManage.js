...
const ResetForgetPassword=({token,email})=>{
  ...
  const navigate = useNavigate();
    ...
    const ResetForgetPasswordSchema = Yup.object().shape({
       email: Yup.string()
    ...
    const Changeforgetpassword =(values,setSubmitting)=>{
      var input_data={
          'ResetToken':token,
          'Email':values.email,
      ...
      axios({
        method:"POST",
        url:localStorage.api_url+"api/v1/Auth/reset-password",
        headers:({'Content-Type':'application/json'}),
        data:input_data
      }).then((function(response)
      {
        toast.success("Your password was changed successfully.",{autoClose:1900})
        navigate("/login")
        ...
        <div className="container h-100">
            ...
            <div className="col col-xl-10">
                ...
                <div className="row g-0">
                    ...
                    <img src={`https://source.unsplash.com/random/?sig=${Math.floor(Math.random() * 1000)}`} alt="Password reset form" className="img-fluid" style={{borderRadius: '0 1rem 1rem 0'}} />
                </div>
                <div className="col-md-6 col-lg-7 d-flex align-items-center">
                    ...
                    <ul>
                        ...
                        onSubmit={(values, { setSubmitting }) => {
                          Changeforgetpassword(values,setSubmitting)
                        }}
                        >
                        {({ isSubmitting }) => (
                            <Form>
                            <div className="d-flex align-items-center mb-3 pb-1">
                                ...
                                <span className="h1 fw-bold mb-0">Change Your Password</span>
                            </div>
...
function ForgetPasswordManage() {
    ...
    useEffect(() => {
        ...
        if(tokenFromURL !=undefined && tokenFromURL!=null)
        {
    ...
    return (
        <>
        {
         ...
         :
         <>
           <ResetForgetPassword token={passwordResetToken}/>
         </>
       }
